...
const ServiceGalleryController = require("./../controllers/admin/svGalleryController");
...
module.exports = app => {
  ...
  //Location
  app.delete(
    "/admin/service/location/:id",
    ensureAuthenticated,
    ServiceController.locationDelete
  );
  app.post(
    "/admin/service/location/:id",
    ensureAuthenticated,
    ServiceController.locationAdd
  );
  ...
  app.post(
    "/admin/service/image",
    ensureAuthenticated,
    ServiceController.imageUplaod
  );
  //Image Edit Section
  app.put(
    "/admin/service/image/:id",
    ensureAuthenticated,
    ServiceController.imageUpdate
  );
  ...
  app.get(
    ...
    ensureAuthenticated,
    ServiceController.banner
  );
  app.post(
    "/admin/service/banner",
    ensureAuthenticated,
    ServiceController.imageBannerUplaod
  );
  //banner Edit Section
  app.put(
    "/admin/service/banner/:id",
    ensureAuthenticated,
  ...
  //Included
  app.post(
    "/admin/service/include/:id",
    ensureAuthenticated,
    ServiceController.include
  );
  app.delete(
    "/admin/service/include/:id",
    ensureAuthenticated,
    ServiceController.includeDelete
  );

  //Excluded
  app.post(
    "/admin/service/exclude/:id",
    ensureAuthenticated,
    ServiceController.exclude
  );
  app.delete(
    "/admin/service/exclude/:id",
    ensureAuthenticated,
    ServiceController.excludeDelete
  );

  //Price Manage
  app.put(
    "/admin/service/pricesale/:id",
    ensureAuthenticated,
    PriceSaleController.priceServiceUpdate
  );
